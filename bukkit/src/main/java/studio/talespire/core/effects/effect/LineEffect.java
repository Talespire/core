...
public class LineEffect extends Effect {
    ...
    public LineEffect(EffectService effectService) {
        super(effectService);
    ...
    public void onRun() {
        ...
        if (subEffectAtEndClass != null) effectService.start(subEffectAtEndClass, subEffectAtEnd, loc);
        if (subEffectAtEndCachedClass != null && effectAtEndCached == null) effectAtEndCached = effectService.start(subEffectAtEndCachedClass, subEffectAtEndCached, loc);
    }

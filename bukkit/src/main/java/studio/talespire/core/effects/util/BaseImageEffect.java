...
import studio.talespire.core.effects.effect.ColoredImageEffect;
...
public abstract class BaseImageEffect extends Effect {
    ...
    public BaseImageEffect(EffectService effectService) {
        super(effectService);
    ...
    public void load(String fileName) {
        ...
        effectService.loadImage(fileName, imageLoadCallback);
    }
